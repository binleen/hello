		...
		<div class="arc_left_box">
			...
			<div class="arc_left">
				...
				<div class="arc_left_content">
					<a href="" class="arc_tittle">文章标题</a>
					<a href=""><img src="" alt="" /></a>
					<div class="arc_des">文章摘要</div>
					<a href="" class="arc_more">阅读全文>></a>
				</div>
			</div>
			<div class="arc_left">
				<div class="arc_left_date">
...
<!--				<a href=""><img src="--><?php //echo yii::app()->request->baseURL?><!--/assets/index/images/houdunwang.jpg" alt="" id="logo_img"/></a>-->
<!--				<ul class="right_des">-->
...
<!--	</div>-->
<!--	<!--[if IE 6]>-->
<!--    <script type="text/javascript" src="--><?php //echo yii::app()->request->baseURL?><!--/assets/index/js/iepng.js"></script>-->
